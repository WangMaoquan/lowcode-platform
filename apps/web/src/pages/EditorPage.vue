...
<template>
  <div class="h-screen flex flex-col" style="background-color: var(--color-dark-bg);">
    <!-- 工具栏 -->
    ...
    <div class="flex-1 flex overflow-hidden">
      <!-- 左侧组件树面板 -->
      <div
        class="w-64 overflow-y-auto"
        style="background-color: var(--color-dark-surface); border-right: 1px solid var(--color-dark-border);"
      >
        <ComponentTree />
      </div>
      ...
      <div
        ...
        style="background-color: var(--color-dark-surface); border-left: 1px solid var(--color-dark-border);"
      >
        <PropertyPanel />
      </div>
    </div>
